= 1. Introducción a Linux y Arquitectura del Sistema
Alex Callejas
:doctype: article
:revdate: Oct 1, 2025

image::https://cdn.hashnode.com/res/hashnode/image/upload/v1759286295118/11117891-f726-44e7-b74f-3fcc2044a537.png?w=1600&h=840&fit=crop&crop=entropy&auto=compress,format&format=webp[1. Introducción a Linux y Arquitectura del Sistema]
...
image::https://cdn.hashnode.com/res/hashnode/image/upload/v1759285331171/fae41be5-f79e-4582-9e76-c13b5341fb27.png?auto=compress,format&format=webp[]
